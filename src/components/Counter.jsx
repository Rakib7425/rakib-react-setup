	...
	return (
		<div>
			...
			<div className='flex gap-3 text-white items-center justify-center py-4 mb-10'>
				<button
					className='bg-pink-700 px-5 py-3 rounded-md active:opacity-80 duration-100 hover:opacity-90'
					onClick={() => dispatch(decrement())}
				>
					Decrement
				</button>
				<button
					className='bg-yellow-700 px-5 py-3 rounded-md active:opacity-80 duration-100 hover:opacity-90'
